...
{
    internal static async Task ShowZoukUserSubscriptionsInformation(
        Message message, ITelegramBotClient client, IUnitOfWork services)
    {
        ...
        foreach (var userSubscription in zoukUserSubscriptions)
        {
    ...
    private static async Task SendCheckInInformation(
        ITelegramBotClient client, ZoukUserSubscription zoukUserSubscription, long chatId)
    {
